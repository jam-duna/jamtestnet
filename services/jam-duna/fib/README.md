...
This is a test Rust-based JAM service named "fib" with refine/accumulate/on_transfer/is_authorized entrypoints:
...
*Current Status*: Tested within the `koute/polkavm` repo, see [#176](https://github.com/koute/polkavm/pull/176) where the PR is WIP as we make `polkatool` output a "JAM-Ready" blob ready to be put on-chain.  Instructions are replicated here for convenience.
